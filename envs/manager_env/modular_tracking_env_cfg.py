...
from gear_sonic.envs.manager_env.robots import g1, h2, oli
...
class ModularTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def override_settings(self):
        ...
        robot_mapping = {
            ...
            "oli": {
                "robot_cfg": oli.OLI_31DOF_CFG,
                "action_scale": oli.OLI_ACTION_SCALE,
                "isaaclab_to_mujoco_mapping": oli.OLI_ISAACLAB_TO_MUJOCO_MAPPING,
                # Translate G1-skeleton motion body names to Oli's robot body names.
                "body_name_aliases": {
                    "pelvis": "base_link",
            ...
            "oli_native": {
                "robot_cfg": oli.OLI_31DOF_CFG,
                "action_scale": oli.OLI_ACTION_SCALE,
                "isaaclab_to_mujoco_mapping": oli.OLI_NATIVE_ISAACLAB_TO_MUJOCO_MAPPING,
                # Motion body names are already Oli-native — no aliasing needed.
                "body_name_aliases": {},
            },
        }
        ...
        self.body_name_aliases = robot_mapping[config["robot"].get("type", "g1")].get(
            "body_name_aliases", {}
        )
